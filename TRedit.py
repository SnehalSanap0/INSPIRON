...
# # client = MongoClient('mongodb+srv://aryansnsk:redclaws_100405@assignment-checker-clus.fxsts.mongodb.net/?retryWrites=true&w=majority&appName=assignment-checker-clus&tls=true')
# # db = client['assignment_feedback']
# # documents_collection = db['documents']



# genai.configure(api_key="AIzaSyC-nBrOODqs8BSt4G01LaOQS1JajxdeHRk")  # Replace with your actual API key
...
#         return f"Error processing image: {e}", 500  # Return error message and code
